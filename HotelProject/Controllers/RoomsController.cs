...
namespace HotelProject.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Roomid,Roomnumber,Roomtype,Roomdescription,Capacity,Floor,Availability,Pricepernight,Hotelid")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Roomid,Roomnumber,Roomtype,Roomdescription,Capacity,Floor,Availability,Pricepernight,Hotelid")] Room room)
        {
            if (id != room.Roomid)
            {
                return NotFound();
