...
namespace HotelProject.Controllers
{
    public class BanksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Bankid,Cardnumber,Cvv,Expirydate,Balance")] Bank bank)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Bankid,Cardnumber,Cvv,Expirydate,Balance")] Bank bank)
        {
            if (id != bank.Bankid)
            {
                return NotFound();
